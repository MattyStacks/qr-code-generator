<template>
  <div class="qr-code-generator">
    ...
    <form @submit.prevent="generateQRCode" class="qr-code-generator__form">
      ...
      <input type="text" id="url" v-model="url" required class="qr-code-generator__input">
      <button type="submit" class="qr-code-generator__button">Generate QR Code</button>
    </form>
    <div v-if="qrCode" class="qr-code-generator__result">
      ...
      <div class="qr-code-generator__actions">
        <button @click="downloadQRCode" class="qr-code-generator__button">Download QR Code</button>
        <button @click="copyQRCode" class="qr-code-generator__button">Copy QR Code</button>
      </div>
    </div>
  </div>
</template>
